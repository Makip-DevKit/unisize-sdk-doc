...
| 種類           | UserAgent                                                                                                                                                          |
| :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| スマートフォン | Mozilla/5.0 (**_iPhone_**; CPU iPhone OS 16*0_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Safari/605.1.15 **_unisizeSDK_** v2.0.0 |
| タブレット     | Mozilla/5.0 (**_iPad_**; CPU iPhone OS 16*4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 Safari/605.1.15 **_unisizeSDK_** v2.0.0     |
